...
def main(args):
    ...
    test_data = satlas.model.dataset.Dataset(
        ...
        transforms=satlas.transforms.get_transform(
            config, config.get("TestTransforms", [])
        ),
        channels=channels,
    ...
    if ("weights" in args) and args.weights:
        ...
        state_dict = torch.load(
            os.path.join(save_path, "best.pth"), map_location=device
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--vis_dir", help="Override visualization directory.", default=None
    )
    parser.add_argument(
        "--probs_dir", help="Override probabilities directory.", default=None
    )
    parser.add_argument("--out_dir", help="Override output directory.", default=None)
    parser.add_argument(
        "--task", help="Only report metrics for this task.", default=None
    )
    ...
    parser.add_argument(
        "--details",
        help="Print detailed scores",
        type=bool,
        default=False,
        action=argparse.BooleanOptionalAction,
    )
    parser.add_argument(
        "--evaluator_params", help="Override evaluator params", default=None
    )
    parser.add_argument(
        "--pick_threshold",
    ...
    parser.add_argument(
        "--weights", help="Path to weights, override SavePath", default=None
    )
    parser.add_argument(
        "--batch_size", help="Override batch size.", type=int, default=None
    )
    parser.add_argument(
        "--num_images", help="Override NumImages.", type=int, default=None
    )
    parser.add_argument(
        "--max_tiles", help="Override TestMaxTiles.", type=int, default=None
    )
