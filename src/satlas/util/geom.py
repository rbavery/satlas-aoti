...
class Segment(object):
    ...
    def extend(self, amount):
        ...
        return Segment(self.start.sub(v), self.end.add(v))
...
class Rectangle(object):
    ...
    def add_tol(self, tol):
        return Rectangle(self.start.sub(Point(tol, tol)), self.end.add(Point(tol, tol)))
    ...
    def intersects(self, other):
        return (
            ...
            and other.end.y >= self.start.y
            and self.end.x >= other.start.x
            and other.end.x >= self.start.x
        )
